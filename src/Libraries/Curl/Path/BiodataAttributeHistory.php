...
class BiodataAttributeHistory extends AbstractCurl implements CurlInterface
{
    /**
     * Account detail
     *
    ...
    {
        return $this->setPath(CurlRestInterface::SUB_BIODATA_ATTRIBUTE_HISTORY)->setBody($data)->post();
    }
}
